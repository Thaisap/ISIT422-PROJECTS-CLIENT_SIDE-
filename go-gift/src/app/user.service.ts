...
loginWithGoogle(body: any):Observable<GoogleCredentials> {
  return this.http.post<GoogleCredentials>('https://gogiftdb.azurewebsites.net/usergooglecredential/auth/google', body);
} */
...
/* updateCurrentUser(id: string, body: Profile): Observable<Profile>{
  console.log(body);
  return this.http.patch<Profile>(`https://gogiftdb.azurewebsites.net/profile/${id}`, body, this.httpOptions);
} */
...
getFriendByEmail(email: string): Observable<ProfileWithImg>{
  return this.http.get<ProfileWithImg>(`https://gogiftdb.azurewebsites.net/friendWithImg/${email}`);
...
getFriendListById(userId: string): Observable<ProfileWithImg[]>{
  return this.http.get<ProfileWithImg[]>(`https://gogiftdb.azurewebsites.net/profileWithImg/friendlist/${userId}`);
...
deleteItemFromWislist(id: string,itemId: string):Observable<ProfileWithImg>{
  return this.http.delete<ProfileWithImg>(`https://gogiftdb.azurewebsites.net/deleteItemFromWislist/${id}/${itemId}`);
...
/* addItemToUserWishlist(userId: string, itemId: string): Observable<Profile>{
  return this.http.patch<Profile>(`https://gogiftdb.azurewebsites.net/profile/item/${userId}`, [itemId], this.httpOptions)
}
 */
// [OLD]Profile Page: update user's tags
/* updateTagInUser(userId: string, tagIds: string[]): Observable<Profile>{
  return this.http.patch<Profile>(`https://gogiftdb.azurewebsites.net/profile/tag/${userId}`, tagIds, this.httpOptions);
}
 */
...
addFriendToUserWithImg(userId: string, friendId: string): Observable<ProfileWithImg[]>{
  return this.http.patch<ProfileWithImg[]>(`https://gogiftdb.azurewebsites.net/profileWithImg/friend/${userId}`, [friendId], this.httpOptions);
}

removeFriendFromUserWithImg(userId: string, friendId: string): Observable<ProfileWithImg[]>{
  return this.http.delete<ProfileWithImg[]>(`https://gogiftdb.azurewebsites.net/profileWithImg/friend/${userId}/${friendId}`, this.httpOptions);
}
...
/* getUser(id: number): Observable<User>{
  return this.http.get<User>('https://gogiftdb.azurewebsites.net/'+ id);
}
 *//*   getUser(id: number) : Observable<User> {
